...
// Maximum height for native scroll container
const NATIVE_SCROLL_MAX_HEIGHT = 208; // equivalent to max-h-52 (13rem = 208px)
 ...
 * Returns the children on the web (Radix handles web scrolling)
 */
